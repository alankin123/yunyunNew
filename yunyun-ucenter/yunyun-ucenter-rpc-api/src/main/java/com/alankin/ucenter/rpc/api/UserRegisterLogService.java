...
import com.alankin.common.base.BaseService;
import com.alankin.ucenter.dao.model.UserRegisterLog;
import com.alankin.ucenter.dao.model.UserRegisterLogExample;

/**
* UserRegisterLogService接口
* Created by alankin on 2018/12/7.
*/
public interface UserRegisterLogService extends BaseService<UserRegisterLog, UserRegisterLogExample> {
